...
**3. Run the examples**
```bash
python 01_data_types/examples.py
```
---
...
- Python `3.8+`
- Optional: Jupyter Notebook for `.ipynb` files
...
<p align="center">Created with ❤️ to document my path to becoming a Python Developer</p>
